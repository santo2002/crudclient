...
import { editFunction, singleUsergetfunc } from '../../Services/Apis';
        ...
        showspin ? <Spiner /> : <div className="container">
          ...
          <Card className='shadow mt-3 p-3'>
            <div className="profile_div text-center">
              <img src={preview ? preview : `${BASE_URL}/uploads/${imgdata}`} alt="imgs" />
            </div>
            ...
            <Form>
              <Row>
                ...
                <Button variant="info" type="submit" onClick={submitUserData} >
                  Submit
                </Button>
              </Row>
